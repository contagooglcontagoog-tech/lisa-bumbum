...
// URL do webhook Vercel — recebe confirmação PAID do Dice e dispara CAPI
const WEBHOOK_URL = process.env.WEBHOOK_URL || 'https://lisa-bumbum.vercel.app/api/webhook-dice';
...
module.exports = async function handler(req, res) {
  ...
  try {
    const { nome, email, cpf, tel, kit_label, kit_id, kit_qtd, total } = req.body;
